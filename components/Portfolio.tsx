  ...
  return (
    <Section id="portfolio" className="bg-veloce-black">
      <div className="text-center mb-20">
        ...
        <h2 className="font-heading text-3xl md:text-5xl font-bold text-white">{t.portfolio.heading}</h2>
      </div>
            ...
            >
              <div className="flex flex-wrap gap-2 mb-6">
                {project.tags.map(tag => (
                  <span key={tag} className="px-3 py-1 bg-white/5 border border-white/5 rounded-full text-xs font-bold text-veloce-gold uppercase tracking-wider">
                    {tag}
                  </span>
                ))}
              </div>
